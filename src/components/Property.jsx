      ...
      return (
        <div className="property">
          <p id="address">{`${this.props.street}
            ...
            ${this.props.city}
             ${this.props.state} ${this.props.zip}`}</p>

          <p>Seller:{this.props.seller}</p>
          <p>Price:{this.props.price}</p>

          <p>
            Bedrooms:{this.props.bedrooms} Bathrooms: {this.props.bathrooms}
          </p>
          ...
          <div className="propButtonHolder">
            ...
            <button
              onClick={() => {
                this.props.deleter(this.props.deleteId, this.props.userId);
              }}
            >
              Delete
            </button>
            ...
            <button
              onClick={() => {
                axios.post(`/properties/addToCrmList/${this.props.deleteId}`, {
                  currentStatus: false,
                  userId: this.props.owningUserId
                });
              }}
            >
              Send to CRM{" "}
